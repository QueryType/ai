# ============================================================
# STORY ENGINE — CHAT INPUT FILE — Stress Test Example
# ============================================================

[meta]
title: Ashenveil — The Ruins Encounter (Stress Test)
version: 1.0
mode: chat
output_transcript: output/ashenveil_chat1_stress_transcript.md
output_runlog: output/ashenveil_chat1_stress_runlog.md
language: en
nsfw: false
