# ============================================================
# STORY ENGINE — CHAT INPUT FILE — Short Example (Rules)
# ============================================================

[meta]
title: Ashenveil — The Ruins Encounter (Short Rules)
version: 1.0
mode: chat
output_transcript: output/ashenveil_chat1_short_rules_transcript.md
output_runlog: output/ashenveil_chat1_short_rules_runlog.md
language: en
nsfw: false
...
guidance: Keep Mira peripheral in this short smoke test. Do not resolve the ruins mystery yet.
...
guidance: Use this phase to spread participation across all three characters and end on commitment rather than more setup.
max_consecutive_turns: 2
